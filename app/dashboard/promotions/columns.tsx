...
export const columns: ColumnDef<Designation>[] = [
  ...
  {
    accessorKey: "previousDesignation.designationName",
    header: "Previous Designation"
  },
  {
    accessorKey: "promotedDesignation.designationName",
    header: "Promoted To"
  },
  {
    accessorKey: "incrementSalary",
  ...
  },
  {
    ...
    header: "Status",
    cell: ({row}) => {
      const status = row.getValue('promotionStatus')
